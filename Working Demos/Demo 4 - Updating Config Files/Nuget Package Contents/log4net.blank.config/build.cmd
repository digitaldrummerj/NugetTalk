...
PowerShell -NoProfile -ExecutionPolicy Bypass -File "..\IncrementNugetVersionNumber.ps1" -NuspecFile "log4net.blank.config.nuspec" -RevisionVersion %REVISION% -MajorVersion %MAJOR% -MinorVersion %MINOR%

echo.
echo nuget pack -OUTPUTDIR %OUTPUTDIR%
nuget pack -ExcludeEmptyDirectories false -OUTPUTDIR %OUTPUTDIR%
